...
enum id {NOIDENTIFIABLE,IDENTIFIABLE};
typedef struct Data{
    int n;
    int m;
    Data(){}
...
class SDDS{
    private:
        ...
        static void insert_id_aux(identifiable<type>* var, int n, type value){
            var->insert_id(n, value);
        }
    ...
    public:
        ...
        static void insert(DS<type>* var, int n, type value, bool id){
            category cat = var->getCategory();
            switch(cat){
                case DOUBLE_LINKED_LIST: {
                    insert_id_aux( ((DSDL<type>*) var), n, value);
                    break;
                }
                case BINARY_SEARCH_TREE: {
                    insert_id_aux( ((DST<type>*) var), n, value);
                    break;
                }
            }
        }
